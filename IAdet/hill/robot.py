...
config_file = "/home/franchesoni/projects/current/detection_loop/mmdetection/IAdet/model/annotations/full_config.py"
checkpoint_file = f"/home/franchesoni/projects/current/detection_loop/mmdetection/data/results/hill/label_{label}/run/latest.pth"
dest_dir = Path(f"data/results/hill/label_{label}/run")
if dest_dir.exists():
